...
const Dashboard: React.FC = () => {
  ...
  const [hasManualCompactPreference, setHasManualCompactPreference] = useState(false);
  ...
  React.useEffect(() => {
    ...
    const applyPreference = (matches: boolean) => {
      if (!hasManualCompactPreference) {
        setIsCompactView(!matches);
      }
    };
  ...
  }, [hasManualCompactPreference]);

  const handleCompactToggle = () => {
    setHasManualCompactPreference(true);
